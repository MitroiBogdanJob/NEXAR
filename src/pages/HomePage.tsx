  ...
  return (
    <div className="animate-fade-in">
      ...
      <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-black overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 md:py-10 lg:py-12">
          <div className="text-center text-white">
            ...
            <p className="text-sm sm:text-base md:text-lg text-white/90 mb-4 sm:mb-6">
              Experiență premium pentru cumpărare și vânzare de motociclete oferită gratuit!
            </p>
            
            {/* Hero Search - Optimizat pentru mobil */}
            <div className="max-w-xl mx-auto mb-4 sm:mb-6">
              <div className="relative backdrop-blur-md bg-white/10 rounded-2xl p-1 border border-white/20">
                <input
                  ...
                  className="w-full pl-4 pr-20 sm:pr-24 py-2.5 sm:py-3 text-sm sm:text-base rounded-xl border-0 bg-white/90 backdrop-blur-sm focus:ring-2 focus:ring-nexar-accent shadow-lg text-gray-900 placeholder-gray-600"
                />
                <button className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-nexar-accent text-white px-3 sm:px-5 py-1.5 sm:py-2 rounded-lg font-semibold hover:bg-nexar-gold transition-colors text-xs sm:text-sm shadow-lg">
                  Caută
                </button>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 justify-center max-w-md mx-auto">
              <Link
                to="/anunturi"
                className="bg-nexar-accent/90 backdrop-blur-sm text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl font-semibold hover:bg-nexar-gold transition-all duration-200 transform hover:scale-105 shadow-lg border border-nexar-accent/30 text-sm sm:text-base"
              >
                Explorează Anunțurile
              </Link>
              <Link
                to="/adauga-anunt"
                className="bg-white/90 backdrop-blur-sm text-gray-900 px-4 sm:px-6 py-2.5 sm:py-3 rounded-xl font-semibold hover:bg-white transition-all duration-200 transform hover:scale-105 shadow-lg border border-white/30 text-sm sm:text-base"
              >
      ...
      {/* CTA Section */}
      <section className="py-8 sm:py-12 bg-gradient-to-r from-gray-900 to-black">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              to="/auth"
              className="bg-nexar-accent/90 backdrop-blur-sm text-white px-5 py-2.5 rounded-xl font-semibold hover:bg-nexar-gold transition-all duration-200 transform hover:scale-105 shadow-lg border border-nexar-accent/30 text-sm"
              onClick={() => window.scrollTo(0, 0)}
            >
            ...
            <Link
              to="/anunturi"
              className="bg-white/90 backdrop-blur-sm text-gray-900 px-5 py-2.5 rounded-xl font-semibold hover:bg-white transition-all duration-200 transform hover:scale-105 shadow-lg border border-white/30 text-sm"
              onClick={() => window.scrollTo(0, 0)}
            >
              Explorează Anunțurile
            </Link>
